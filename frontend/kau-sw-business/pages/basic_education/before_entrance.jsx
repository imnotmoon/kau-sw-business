	...
	return (
		<ContentFrame title="입학전 교육" state={3}>
			<Content>
				...
				<li>
					(AI+X 이중언어인 교육 시작) 모든 학과의 학생들이 컴퓨팅 사고력 기반의 AI‧SW 역량을 갖추고 자신의
					분야를 혁신할 융합형 인재로 성장할 첫 단계
				</li>
				<li>
					(AI‧SW 학습동기 부여) 신입생들이 SW기술 기반의 시대적 변화를 인식하고 흥미를 갖게 함으로써, 입학 후
					AI‧SW 교육에 대한 자기주도적 학습자세 유도
				</li>
				<li>
					(AI‧SW분야 학습 경험) 입학 전 SW분야 학습 경험이 없는 신입생들에게 프로그래밍을 즐겁게 경험하는
					기회를 제공하여, 입학 후 AI‧SW 학습에 연착 지원
				</li>
				<br />
				<br />
				...
				<li>
					전년도 1학년 대상 SW 교양필수과목인 ‘컴퓨팅적사고와 문제해결’ 수강생 대상 설문 결과를 분석하여
					교과목 구성 방향 설정
				</li>
				<li>신설 AI‧SW기초교과목 콘텐츠 구성방향</li>
				<Li>
					(Needs) 전 산업 분야뿐만 아니라 우리 생활을 둘러싸고 있는 AI‧SW 기술사례와 컴퓨터과학 원리를
					인지함으로써, 입학 후 AI‧SW융합교육의 필요성을 인식
				</Li>
				<Li>(Fun) 초심자가 흥미를 갖을 수 있도록 재미있는 동영상과 게임을 최대한 활용</Li>
				<Li>
					(Easy) 초심자도 쉽게 따라 할 수 있는 블록형 교육용 프로그래밍 언어인 스크래치(Scratch)를 활용한
					프로그래밍 교육
				</Li>
...
export default withHead(BeforeEntrance);
