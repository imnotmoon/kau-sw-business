	...
	return (
		<ContentFrame title="소개" state={3}>
			<Content>
				...
				<p>
					Air Mobility 산업생태계(Ecosystem)는 비행체 설계‧제작을 위한 HW 인프라 요소기술, 비행체
					자율주행시스템을 위한 AI‧SW 핵심 기술, 모빌리티 서비스 산업 분야를 위한 AI+X 융합 기술, 이에 기반한
					다양한 응용 산업 등으로 구성
				</p>
				<br />
				<Li>
					<strong>(HW 인프라)</strong> 비행체 제작을 위한 기체 설계 및 제작, 전기전자장치, 초고속 통신, 고효율
					배터리, 충전인프라 등 요소기술
				</Li>
				<Li>
				...
				<Li>
					<strong>(AI+X 융합기술)</strong> 모빌리티 플랫폼, 교통‧관제, 스마트 물류, 승차 공유 서비스, 운송관리
					등에 필요한 AI 융합 기술
				</Li>
